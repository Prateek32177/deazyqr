...
export const ShareIcon = (
  <svg
    ...
    stroke-width="1.5"
    stroke="currentColor"
    class="w-5 h-5 mx-1 text-green-500 "
  >
    <path
...
export const loaderIcon = (
  <svg
    ...
    stroke-linecap="round"
    stroke-linejoin="round"
    class="feather feather-loader  animate-spin h-5 w-5 mr-1"
  >
...
export const SpinUpdateIcon = (
  <svg
    ...
    strokeWidth={1.5}
    stroke="currentColor"
    className="h-8 w-8 rounded-lg mb-3 animate-spin"
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
