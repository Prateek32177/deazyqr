...
import { TypewriterEffect } from "@/MotionEffect/TyypewriteEffect";
import { Badge } from "@/MotionEffect/Badge";
    ...
    <>
      <div className="flex flex-col gap-16 items-center">
        ...
        <Link
          ...
          className="text-white items-center bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2  flex"
        >
          {flashIcon}
          Generate Dynamic QR
        </Link>
        ...
        <span className="text-3xl lg:text-4xl !leading-tight mx-auto max-w-lg text-center font-bold ">
          <TypewriterEffect
            className="text-2xl lg:text-3xl !leading-tight mx-auto max-w-lg text-center font-bold "
            words={words}
          />
